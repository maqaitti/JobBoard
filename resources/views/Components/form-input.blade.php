...
<input {{ $attributes->merge(['class'=>"block min-w-0 grow bg-white py-1.5 px-4 pl-1 text-base text-gray-900 placeholder:text-gray-400 focus:outline-none sm:text-sm/6"])}}>
</div>